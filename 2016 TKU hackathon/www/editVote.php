...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <form class="form-horizontal" action="editVote.php?subjectID="<?php echo $_GET["subjectID"]?> method="POST">
      <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
        <input id="textinput" name="subject" type="text" class="form-control input-md" value=<?php echo $title;?> >
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <select id="subjectClass" name="subjectClass" class="form-control">
            <option value="1" checked>社團</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <select id="VoteClass" name="VoteClass" class="form-control">
            <option value="1" checked>一般投票</option>
 ...
 <!-- basic_1 -->
    <div id="voteClass_1">
      <div class="form-group">
        ...
        <div class="col-md-2">
        <input id="textinput" name="VoteClass_1[]" value="<?php echo VoteClass_1[0]?>" type="text" class="form-control input-md">
        </div>
      </div>
      ...
      <div class="form-group">
        <label class="col-md-4 control-label" for="textinput">項目</label>
        <div class="col-md-2">
        <input id="textinput" name="VoteClass_1[]" value="<?php echo VoteClass_1[1]?>" type="text" class="form-control input-md">
        </div>
      </div>
    </div>
 ...
 <!-- weight_3 -->
    <div id="voteClass_3" hidden="true">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="n9" type="date" placeholder="" name="createDate" value="<?php echo $createDate?>" style="width: 90%;" ></input>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="n9" type="date" placeholder="" name="endDate" value="<?php echo $endDate?>" style="width: 90%;"></input>
        </div>
      </div>
