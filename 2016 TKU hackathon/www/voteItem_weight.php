<?php 
	...
	$sql = "SELECT * FROM voteItem_weight where subjectID = ".$subjectID;
	...
	for($i=0 ;$i<$total_record;$i++){
		...
		$ItemName = $row["name"];
		$VotingNum = $row["score"];
		$vote_array[$i] = array('ItemName' => $ItemName , 'weight' => $weight , 'VotingNum' => $VotingNum);
		$chart_array[$i] = array('category'=> $ItemName , 'value' => $VotingNum*$weight);
	};
                ...
                $(document).ready(function () {
                        ...
                        schema: {
                            model: {
                                ...
                                fields: {
                                    ...
                                    weight: { editable: false,validation: { required: true} },
                    ...
                    $("#grid").kendoGrid({
                        ...
                        columns: [
                            ...
                            { width: 300,field: "weight",title: "權重"},
